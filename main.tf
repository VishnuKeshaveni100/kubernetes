...
#Setting up the first resource for the IAM role. This ensures that the role has access to EKS.
...
#Attach the following two policies to it:
...
#Set up an IAM role for the worker nodes and attach the following polices to it.
